...
.word	SYS | NVIE	/* extended inst trap */
.word	t_ei

.word	SYS | NVIE	/* priveleged inst trap */
.word	t_pi

.word	SYS | NVIE	/* syscall inst trap */
.word	t_sc
...
.word	t_nmi
#else
.word	SYS | NVIE	/* non maskable interrupt */
.word	t_nmi
#endif
...
.word	SYS | NVIE	/* vectored interrupts */
...
i_mb:
push	*r15, r3		/* save registers */
push	*r15, r4
push	*r15, r5
ld	r4, _mbfrom		/* set up move parameters */
ld	r5, _mbto
ld	r3, _mbcnt
ldir	*r5, *r4, r3		/* move words from multibus to local memory */
mset				/* return multibus */
ld	r3,$1
ld	_mbflag, r3
pop	r5, *r15		/* restore registers */
pop	r4, *r15
pop	r3, *r15
call	pushregs		/* normal interrupt handling */
call	_mbmore			/* check if there is more to do */
jp	intret			/* return to interrupted code */
