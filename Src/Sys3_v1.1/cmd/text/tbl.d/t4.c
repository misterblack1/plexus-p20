...
garray(qcol)
{
style = getcore(MAXHEAD*qcol, sizeof(int));
evenup = getcore(qcol, sizeof(int));
ctop = getcore (qcol*MAXHEAD, sizeof(int));
lefline = getcore(MAXHEAD*qcol, sizeof (int));
font = getcore(MAXHEAD*qcol, 2);
csize = getcore(MAXHEAD*qcol, 4);
vsize = getcore(MAXHEAD*qcol, 4);
cll = getcore(qcol, CLLEN);
sep = getcore(qcol+1, sizeof(int));
sep++; /* sep[-1] must be legal */
used = getcore(qcol, sizeof(int));
lused = getcore(qcol, sizeof(int));
rused = getcore(qcol, sizeof(int));
doubled = getcore(qcol, sizeof(int));
acase = getcore(qcol, sizeof(int));
topat = getcore(qcol, sizeof(int));
}
getcore(a,b)
{
char *x;
