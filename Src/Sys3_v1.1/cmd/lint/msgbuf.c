...
short	msgtype[ NUMMSGS ] = {
	...
	STRINGTY | SIMPL,	/* [18] "can't take & of %.8s" */
	...
	PLAINTY,	/* [83] "nonportable field type" */
	...
	STRINGTY,	/* [98] "redeclaration of %.8s" */
