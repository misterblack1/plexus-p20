...
#ifdef PLEXUS_SVR2
/* SVR2 lacks opendir/readdir/closedir - provided by compat.c */
#ifndef _PLEXUS_DIR_H
#define _PLEXUS_DIR_H
#include <sys/dir.h>
...
#else
#ifdef PLEXUS_SVR2
/* SVR2: no signal blocking. Child wait done synchronously. */
#define blockchld()
#define unblockchld()
#define chldsuspend() pause()
#else
