...
#define SYMSEG	(10 << 8)		/* symbol table segment */
...
#define	NETSEG	(24 << 8)		/* network buffers segment */
#define	NSPARE	(25 << 8)		/* network spare segment */
...
#define P_MUBLK1	mapport(SDSEG1, 30)	/* user block in ovly 1 */
#define P_MUBLK2	mapport(SDSEG2, 30)	/* user block in ovly 1 */
#define P_MUBLK3	mapport(SDSEG3, 30)	/* user block in ovly 1 */
#define P_MUBLK4	mapport(SDSEG4, 30)	/* user block in ovly 1 */
...
#define MBNETSEG	0x8		/* network buffers segment */
