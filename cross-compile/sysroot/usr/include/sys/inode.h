...
struct	inode
{
	...
	struct {
		union {
			...
			struct {
				int	*i_dfs;		/* dfs identifier */
				ushort	i_dfsin;	/* remote inode ord */
				ino_t	i_dfsino;	/* .. i_number */
				dev_t	i_dfsdev;	/* .. dev */
				ushort	i_dfsstat;	/* stat of rinode */
			} dfs;
		} i_p;
...
#define	IRMT	0400		/* file is remote */
...
#define i_dfsid i_blks.i_p.dfs.i_dfs
#define i_dfsi i_blks.i_p.dfs.i_dfsin
#define i_dfsst i_blks.i_p.dfs.i_dfsstat
#define i_ddino i_blks.i_p.dfs.i_dfsino
#define i_dddev i_blks.i_p.dfs.i_dfsdev
