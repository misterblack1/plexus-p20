...
#define PDLOGVOL	16
#define PDUNITS		4	/* also defined in 68k im.c */
#define IDINT (0x80 << 1)

#define PDONPRF  1		/* true on profiling timer (one a second) */
#define PDOFFPRF 2		/* turn off profiling timer */
#define PDZPRF   3		/* clear profiling tables */
