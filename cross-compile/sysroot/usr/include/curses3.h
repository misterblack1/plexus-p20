...
#ifdef SYS3
#define raw() (_tty.sg_flags|=O_RAW, _pfast=_rawmode=TRUE, stty(_tty_ch,&_tty))
#define noraw()	(_tty.sg_flags&=~O_RAW,_rawmode=FALSE,_pfast=!(_tty.sg_flags&O_CRMOD),stty(_tty_ch,&_tty))
#define crmode() (_tty.sg_flags |= O_XTABS, _rawmode = TRUE, stty(_tty_ch,&_tty))
#define nocrmode() (_tty.sg_flags &= ~O_XTABS,_rawmode=FALSE,stty(_tty_ch,&_tty))
#define echo()	 (_tty.sg_flags |= O_ECHO, _echoit = TRUE, stty(_tty_ch, &_tty))
#define noecho() (_tty.sg_flags &= ~O_ECHO, _echoit = FALSE, stty(_tty_ch, &_tty))
#define nl()	 (_tty.sg_flags |= O_CRMOD,_pfast = _rawmode,stty(_tty_ch, &_tty))
#define nonl()	 (_tty.sg_flags &= ~O_CRMOD, _pfast = TRUE, stty(_tty_ch, &_tty))
