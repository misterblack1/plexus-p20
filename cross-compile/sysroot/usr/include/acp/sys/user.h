 ...
 * loc 0x200000-(USIZE*4096)(2 MB memory);
 * loc 0x80000-(USIZE*4096)(512k memory);
...
struct	user
{
	...
	unsigned short u_umap[1];	/* copy of users map  2 MB memory */
	label_t	u_qsav;			/* label variable: quits, interrupts */
	...
	struct file *u_ofile[NOFILE];	/* ptrs to file structs of open files*/
