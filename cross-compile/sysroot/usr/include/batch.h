...
#define LINEFIL "/usr/batch/lines"
#define CUBATCH "/dev/dn2"	/* Dial-up batch device */
#define LOGINBATCH "batch"	/* batch login name */
#define UIDBATCH 10            	/* User-Id for "batch" */
#define SHQUIDBATCH 11          /* User-Id for "shqer" */
#define QUEDIR	"/usr/batch/sque"	/* shqer directory */
...
#define DEVFD	0	/* ICP device file descriptor */
...
#define MAXLNS	6
struct lines {
	char *l_host;		/* batch host machine */
	char *l_sys;		/* This system */
	char *l_dir;		/* home directory */
	char *l_prefix;		/* batch prefix */
